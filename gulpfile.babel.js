...
function mergeAll(dest) {
  return merge(
    ...
    pipe(['./src/theme/assets/**/*.css'], `./build/${dest}/assets`),
    pipe(['./src/theme/assets/**/*.js'], `./build/${dest}/assets`),
    pipe(['./src/theme/assets/img/**/*.jpg', './src/theme/assets/img/**/*.png'], `./build/${dest}/assets/img`),
    pipe(['./src/theme/assets/fonts/**/*.woff2', './src/theme/assets/fonts/**/*.woff', './src/theme/assets/fonts/**/*.tff'], `./build/${dest}/assets/fonts`)
  )
}
...
function buildJS(target) {
  ...
  let tasks = files.map( file => {
    ...
    // Uglification of ethereum-ens creates build errors in Gulp:
